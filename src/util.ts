...
export const getTotalErrorsCount = (errorMap: ErrorSummaryMap): number =>
  ...
  // with the previous bundler (microbundle) that was incorrectly compiling that
  // (see: https://github.com/TimMikeladze/tsc-baseline/issues/21). Kept as-is since
  // Array.from is equally clear.
